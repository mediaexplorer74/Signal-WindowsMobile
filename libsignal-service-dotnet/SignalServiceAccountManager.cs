...
namespace libsignalservice
{
    ...
    public class SignalServiceAccountManager
    {
        ...
        */
        ...
        public SignalServiceAccountManager(SignalServiceConfiguration serviceConfiguration, 
            object p, string username, string password, 
            int deviceId, string uSER_AGENT, 
        ...
        // global::Signal_Windows.Lib.SignalWebSocketFactory
        public Task<string> GetNewDeviceUuidAsync(ISignalWebSocketFactory signalWebSocketFactory, CancellationToken token)
        {
        ...
        public Task<int> FinishNewDeviceRegistrationAsync(object provisionMessage, string tmpSignalingKey, string password, bool v1, bool v2, int registrationId, string v3, CancellationToken token)
        {
            throw new NotImplementedException();
        }

        public Task<SignalServiceProvisionMessage> GetProvisioningMessageAsync(IdentityKeyPair tmpIdentity, CancellationToken token)
        {
            throw new NotImplementedException();
        }
        ...
        // TODO
        public Task SetPreKeysAsync(IdentityKey identityKey, SignedPreKeyRecord signedPreKeyRecord, List<PreKeyRecord> oneTimePreKeys, CancellationToken token)
        {
            throw new NotImplementedException();
        }
