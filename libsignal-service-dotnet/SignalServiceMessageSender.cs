...
namespace libsignalservice
{
    ...
    public class SignalServiceMessageSender
    {
        ...
        public SignalServiceMessageSender(CancellationToken token, SignalServiceConfiguration serviceConfiguration, string username, string password, int deviceId, 
            global::Signal_Windows.Storage.Store store, 
            string uSER_AGENT, bool v, 
            SignalServiceMessagePipe pipe, object p1, object p2)
        {
        }
